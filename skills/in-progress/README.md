...
- **[teach](./teach/SKILL.md)** — Turn the current directory into a stateful teaching workspace, grounded in a mission document and a resource library, that produces self-contained HTML lessons one tightly-scoped idea at a time.
